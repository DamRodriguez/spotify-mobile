...
const iconColor = colors.opaqueWhite;

export const WorldIcon = ({ size = 20, color = iconColor }: { size?: number, width?: string, height?: string, color?: string }) => {
  return (
...
export const DownloadIcon = ({ size = 28, color = iconColor }: { size?: number, width?: string, height?: string, color?: string }) => {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill={color}>
...
export const ShareIcon = ({ size = 28, color = iconColor }: { size?: number, width?: string, height?: string, color?: string }) => {
  return (
...
export const MixIcon = ({ size = 28, color = iconColor }: { size?: number, width?: string, height?: string, color?: string }) => {
  return (
