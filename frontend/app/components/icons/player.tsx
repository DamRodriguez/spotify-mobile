...
export const HideIcon = ({ size = 40, color = "#fff" }: { size?: number, width?: string, height?: string, color?: string }) => {
  return (
...
export const BackIcon = ({ size = 35, color = "#fff" }: { size?: number, width?: string, height?: string, color?: string }) => {
  return (
...
export const NextIcon = ({ size = 35, color = "#fff" }: { size?: number, width?: string, height?: string, color?: string }) => {
  return (
    <Svg
      width={size}
      height={size}
...
export const RepeatIcon = ({ size = 30, color = "#fff" }: { size?: number, width?: string, height?: string, color?: string }) => {
  return (
